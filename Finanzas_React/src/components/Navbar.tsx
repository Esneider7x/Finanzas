...
const navItems = [
    { text: "Inicio", path: "/Usuarios" , icon: <HomeIcon sx={{color: '#fff'}}/>},
...
const Navbar = () => {
    ...
    const drawer = (
        <Box onClick = {handleDrawerToggle} sx = {{ textAlign: 'center', backgroundColor: '#1e1e1e', height: '100%'}}>
            <Typography variant="h6" sx = {{my: 2, color: '#fff'}}>Administracion de Uusuarios</Typography>
